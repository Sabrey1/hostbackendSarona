...
from app.schemas.customer.customer import CustomerCreate, CustomerRead, CustomerUpdate
from app.crud.customer.customer import  create_customer, get_all_customer, get_customer, update_customer, delete_customer
