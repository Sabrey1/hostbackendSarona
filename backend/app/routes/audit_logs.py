...
from app.schemas.audit_logs import AuditLogsCreate, AuditLogsRead, AuditLogsUpdate
from app.crud.audit_logs import  create_audit_logs, get_all_audit_logs, get_audit_logs, update_audit_logs, delete_audit_logs
